...
-(void) service_count : (NSString *) str_type
{
  ...
  /*  NSError *error;
   ...
   dic_response = [NSJSONSerialization JSONObjectWithData:Get_data options:0 error:NULL];
    ...
    {
        UIAlertView *alertr = [[UIAlertView alloc]initWithTitle:@"Atenção!" message:[dic_response valueForKeyPath:@"MessageInfo"] delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alertr show];
    }
...
-(void) share_webservice
{
    ...
    {
        [[[UIAlertView alloc]initWithTitle:@"Atenção!" message:[dic_res valueForKeyPath:@"MessageInfo"] delegate:self cancelButtonTitle:nil otherButtonTitles:@"Ok", nil] show];
    }
    else
    {
